<div class="col-md-4">
    <div class="dashboard__main-left nav flex-column nav-pills me-3 das-nav-sidebar-akkjlw" id="v-pills-tab" role="tablist"
        ...
        <a href="{{ route('user.home') }}" class="nav-link {{ request()->is('user/home')?'active':'' }}"><span class="side-i-style-oxiz"><i
                    class="fa-regular fa-user"></i></span> <span class="side-text-style-oxiz">my
                profile</span></a>


        <a href="{{ route('user.my-orders') }}" class="nav-link justify-content-between  {{ request()->is('user/my-orders')?'active':'' }} "><span><span
        ...
        <a href="{{ route('user.my-wishlist') }}" class="nav-link justify-content-between {{ request()->is('user/my-wishlist')?'active':'' }} "><span><span
        ...
        @if ($userDetails->subscribe_id !== 0)
            <a href="{{ route('user.membership-product') }}" class="nav-link {{ request()->is('user/membership-product')?'active':'' }}"><span class="side-i-style-oxiz"><i
                        class="fa-solid fa-box-open"></i></span>
                <span class="side-text-style-oxiz">Membership Product</span></a>
        @endif

        <a href="{{ route('user.edit-profile') }}" class="nav-link {{ request()->is('user/edit-profile')?'active':'' }}"><span class="side-i-style-oxiz"><i
