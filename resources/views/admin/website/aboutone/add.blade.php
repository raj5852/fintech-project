...
<div class="page-wrapper">
	<div class="page-content">
			...
			<div class="ps-3">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb mb-0 p-0">
						...
						<li class="breadcrumb-item active" aria-current="page">Create About One</li>
					</ol>
				</nav>
			</div>
			<div class="ms-auto">
		...
		<div class="card">
			<div class="card-body">
				<form class="g-3" method="POST" action="{{ route('store.aboutone') }}" enctype="multipart/form-data">
					@csrf
					<div class="row">
						<div class="col-md-6">
							<label for="inputFirstName" class="form-label">Title </label>
							<input type="text" class="form-control" name="title" id="inputFirstName" placeholder="Enter Title" required value="{{ old('title') }}">
						</div>
                        ...
                        <div class="col-md-6">
							...
							<textarea class="form-control"  name="details" placeholder=" description..." rows="3" required>
                                {{ old('title') }}
                            </textarea>
						</div>
