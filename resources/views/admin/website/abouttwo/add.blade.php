...
<div class="page-wrapper">
	<div class="page-content">
		...
		<div class="card">
			<div class="card-body">
				<form class="g-3" method="POST" action="{{ route('store.abouttwo') }}" enctype="multipart/form-data">
					@csrf
					<div class="row">
						<div class="col-md-6">
                        ...
                        <div class="col-md-6">
							...
							<textarea class="form-control"  id="summernote"  name="details" placeholder=" description..." rows="3" required>
                                {{ old('details') }}
                            </textarea>
						</div>
