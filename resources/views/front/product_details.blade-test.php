                ...
                function fetchComments() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var commentList = $('#comments-items');

                            // Clear the comment list before appending
                            commentList.empty();
                            ...
                            comments.forEach(function(comment) {
                                ...
                                var commentHtml = '<div class="comment">' +
                                    ...
                                    '<li>' +
                                    '<button class="dropdown-item delete-comment" data-id="' +
                                    comment.id + '" >' +
                                    ...
                                    '</div>' +
                                    '</div>' +
                                    '<p class="date">' + comment.comment + '</p>' +
                                ...
                                var icoDivs = document.querySelectorAll('.ico');

                                icoDivs.forEach(function(div) {
                                    if (authcheck == 1) {
                                        // console.log(comment.user.id)
                                        //  1 = admin
                                        if (comment.user.id === userId || userId === 1) {
                        ...
                        error: function(error) {
                            // toastr.warning('Please log in to view comments.', 'Login Required');
                            // alert('das')
                        }
                    });
                }
