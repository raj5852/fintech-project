                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="https://fintechforexea.com"
                                ...
                                <img src="https://fintechforexea.com/backend/setting/15501png" class="logo"
                                    alt="Laravel Logo"
                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none;  max-width: 150px;">
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Congratulations! New  <b> {{ $product->product_name }}  have been added to your <b>{{ $user->member ?->membership_name }}</b>

                                        </p>
                                        <h4>Here is the new product link-:</h4>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a href="
                                                                            @php
$keys = array_keys($product->product_url);
                                                                            echo   end($keys); @endphp
                                                                            "
                                                                                class="button button-primary"
                                                                                target="_blank" rel="noopener"
                                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #2d3748; border-bottom: 8px solid #2d3748; border-left: 18px solid #2d3748; border-right: 18px solid #2d3748; border-top: 8px solid #2d3748;">Click
                                                                                Here</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        If you're having trouble clicking the "Visit Website" button,
                                                        ...
                                                        into your web browser: <span class="break-all"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; word-break: break-all;"><a
                                                                href="http://fintechforexea.com/"
                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">http://fintechforexea.com/</a></span>
                                                    </p>
