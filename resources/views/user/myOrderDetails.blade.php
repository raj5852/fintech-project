    ...
    <div class="dashboard">
        <div class="container">
            ...
            <div class="mobile-version-menu">
                <ul>
                    <li><a class="item common-btn" href="#">My Profile</a></li>
                    <li><a class="item common-btn active" href="#">My Orders</a></li>
                    <li><a class="item common-btn" href="#">My Wallet</a></li>
                    <li><a class="item common-btn" href="#">My Wishlist</a></li>
                    <li><a class="item common-btn" href="#">Membership Product</a></li>
                    <li><a class="item common-btn" href="#">Edit Profile</a></li>
                ...
                <div class="dashboard__profile-content oder-details-ov-control">
                    <div class="dashboard__profile-order">
                        ...
                        <div class="u-order-details">
                            ...
                            <div class="_right">
                                <div class="content">
                                    <h1 class="_name">Adobe Audition Pro</h1>
                                    <h1 class="__box"><span class="text">Purchase Date: </span><span class="__res">12 jan, 2023</span></h1>
                ...
                <div class="row gx-5">
                    <div class="col-xl-4">
                        <div class="dashboard__main-left nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
						    ...
						    <a href="{{route('user.home')}}" class="nav-link"> <img src="{{ asset('frontend/') }}/img/ic1.png" alt="ic1"> my profile</a>
                            <a href="{{route('user.my-orders')}}" class="nav-link justify-content-between active"><span><img src="{{ asset('frontend/') }}/img/ic2.png" alt="ic1"> <span>my Orders</span></span> <span class="dashboard__main-count">{{ $orders->count() }}</span></a>
                            <a href="{{route('user.my-wallet')}}" class="nav-link "><img src="{{ asset('frontend/') }}/img/ic3.png" alt="ic1"> <span>My wallet</span></button>
                            <a href="{{route('user.my-wishlist')}}" class="nav-link justify-content-between"><span><img src="{{ asset('frontend/') }}/img/ic4.png" alt="ic1"> <span>My wishlist</span>
                                </span><span class="dashboard__main-count">{{ $wishlists->count() }}</span></button>
                            @if ($userDetails->subscribe_id !== 0)
                                <a href="{{route('user.membership-product')}}" class="nav-link"><img src="{{ asset('frontend/') }}/img/membership.png" alt="ic1"> Membership Product</a>
                            @endif
                            <a href="{{route('user.edit-profile')}}" class="nav-link"> <img src="{{ asset('frontend/') }}/img/ic6.png" alt="ic1">Edit Profile</a>
