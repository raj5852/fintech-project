                ...
                <div class="row gx-5">
                    <div class="col-xl-4">
                        <div class="dashboard__main-left nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                            ...
                            <a href="{{route('user.my-orders')}}" class="nav-link justify-content-between"><span><img src="{{ asset('frontend/') }}/img/ic2.png" alt="ic1"> <span>my Orders</span></span> <span class="dashboard__main-count">{{ $orders->count() }}</span></a>
                            ...
                            <a href="{{route('user.change-password')}}" class="nav-link active"> <img src="{{ asset('frontend/') }}/img/ic5.png" alt="ic1"> Change Password</button>
                    ...
                    <div class="col-xl-8">
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-pass" role="tabpanel"
