            ...
            <div class="dashboard__header">
              ...
              <div class="mobile-version-menu">
                <ul>
                    ...
                    <li><a class="item common-btn active" href="{{route('user.my-wishlist')}}">My Wishlist</a></li>
                ...
                <div class="table-responsive ab-table-wrap order wish-list">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                <span  onclick="this.parentElement.parentElement.style.display='none';"  class="delete-list-i"><i class="fa-solid fa-xmark"></i></span>
                            ...
                            <tr>
                                ...
                                <span  onclick="this.parentElement.parentElement.style.display='none';"  class="delete-list-i"><i class="fa-solid fa-xmark"></i></span>
                                    ...
                                    <div class="product-rp">
                                        ...
                                        <h1 class="__name">Microsoft Microsoft Office Office Microsoft </h1>
                                    </div>
                                </td>
                                <td><span class="__pp">$45.00</span></td>
                                <td><a class="add-to-cart-btn" href="#">Add to cart</a></td>
                            ...
                            <tr>
                                ...
                                <span  onclick="this.parentElement.parentElement.style.display='none';"  class="delete-list-i"><i class="fa-solid fa-xmark"></i></span>
                                    ...
                                    <div class="product-rp">
                                        ...
                                        <h1 class="__name">Microsoft Office Microsoft Office Microsoft Office Microsoft Office</h1>
                                    </div>
                                </td>
                                <td><span class="__pp">$45.00</span></td>
                                <td><a class="add-to-cart-btn" href="#">Add to cart</a></td>
            ...
            <div class="dashboard__main">
                <div class="row gx-5">
                    ...
                    <div class="dashboard__main-left nav flex-column nav-pills me-3 das-nav-sidebar-akkjlw" id="v-pills-tab" role="tablist"
                            ...
                            <a href="{{route('user.my-wishlist')}}" class="nav-link active justify-content-between"><span><span class="side-i-style-oxiz"><i class="fa-solid fa-folder-plus"></i></span> <span class="side-text-style-oxiz">my WishList</span>
