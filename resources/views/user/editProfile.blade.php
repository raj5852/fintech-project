            ...
            <div class="dashboard__header">
              ...
              <div class="mobile-version-menu">
                <ul>
                    ...
                    <li><a class="item common-btn active" href="{{route('user.edit-profile')}}">Edit Profile</a></li>
                    <li><a class="item common-btn" href="{{ route('logout') }}">Logout</a></li>
                </ul>
                
            </div>
            <div class="mobile-show-content">
            <form autocomplete="off" action="{{ route('user.update.profile') }}" method="POST"
                ...
                <div class="form-group input-box-control">
                    <span>Name:</span>
                    <input type="name" value="{{ Auth::user()->name }}" class="input-control-ibx"
                        name="name">
                </div>
                <div class="form-group input-box-control">
                    <span>Email:</span>
                    <input type="email" value="{{ Auth::user()->email }}" readonly
                        class="input-control-ibx" name="email">
                </div>
            ...
            <div class="dashboard__main">
                <div class="row gx-5">
                    ...
                    <div class="dashboard__main-left nav flex-column nav-pills me-3 das-nav-sidebar-akkjlw" id="v-pills-tab" role="tablist"
                            ...
                            @endif
                            <a href="{{route('user.edit-profile')}}" class="nav-link active"><span class="side-i-style-oxiz"><i class="fa-solid fa-user-pen"></i></span> <span class="side-text-style-oxiz">Edit Profile</span></a>
