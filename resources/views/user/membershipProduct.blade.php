        ...
        <div class="container">
            ...
            <div class="mobile-version-menu">
                <ul>
                    ...
                    <li><a class="item common-btn active" href="{{route('user.membership-product')}}">Membership Product</a></li>
            ...
            <div class="dashboard__main">
                <div class="row gx-5">
                    ...
                    <div class="dashboard__main-left nav flex-column nav-pills me-3 das-nav-sidebar-akkjlw" id="v-pills-tab" role="tablist"
                            ...
                            @if ($userDetails->subscribe_id !== 0)
                                <a href="{{route('user.membership-product')}}" class="nav-link active"><span class="side-i-style-oxiz"><i class="fa-solid fa-box-open"></i></span> <span class="side-text-style-oxiz">Membership Product</span></a>
                            @endif
