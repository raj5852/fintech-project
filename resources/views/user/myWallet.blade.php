            ...
            <div class="dashboard__header">
             ...
             <div class="mobile-version-menu">
                <ul>
                    ...
                    <li><a class="item common-btn active" href="{{route('user.my-wallet')}}">My Wallet</a></li>
            ...
            <div class="mobile-show-content">
                <div class="dashboard__profile-content">
                    <div class="dashboard__profile-order">                            
                        <span class="dashboard__profile-bltitle  mb-2">Wallet History</span>
                        <!-- new table start  -->
                        <div class="table-responsive ab-table-wrap wallet">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>Date</th>
            ...
            <div class="dashboard__main">
                <div class="row gx-5">
                    ...
                    <div class="dashboard__main-left nav flex-column nav-pills me-3 das-nav-sidebar-akkjlw" id="v-pills-tab" role="tablist"
                            ...
                            <a href="{{route('user.my-wallet')}}" class="nav-link active"><span class="side-i-style-oxiz"><i class="fa-regular fa-heart"></i></span> <span class="side-text-style-oxiz">my Wallet</span></button>
