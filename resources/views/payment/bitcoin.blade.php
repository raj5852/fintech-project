...
<body>
  ...
  <div class="flex-center position-ref full-height">
    <div class="content">
      ...
      <form action="{{ route('bitcoin.payment') }}"  method="get" >
        @csrf
        ...
        @elseif($type == 'recharge')
          ...
          <button type="submit" class="btn btn-success">Pay ${{ number_format($data['amount'] , 2) }} from Bit Coin</button>
        @elseif($type == 'subscribe')
          ...
          <button type="submit" class="btn btn-success">Pay ${{ number_format($data['total_subscription_fee'] , 2) }} from Bit Coin</button>
        @endif
